...
void coletar_maquinas_por_categoria_e_estado_avl(EstruturaDados estrutura_dados, const char *categoria_cod, GerenciadorListaEstados *gerenciador_estados_ref)
{
  ...
  coletar_maquinas_por_categoria_e_estado_avl((EstruturaDados)raiz->esquerda, categoria_cod, gerenciador_estados_ref);
  ...
  coletar_maquinas_por_categoria_e_estado_avl((EstruturaDados)raiz->direita, categoria_cod, gerenciador_estados_ref);
}